...
static void ThreadSafeMessageBox(const std::string& message, const std::string& caption, uint32_t style)
{
...
#else
    QSplashScreen splash(QPixmap(":/images/splash_simple"), 0);
#endif 
