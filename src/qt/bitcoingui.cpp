    ...
    nWeight(0)
{
    ...
    qApp->setStyleSheet("QMainWindow { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} #spacer2 { background:rgb(65,84,101);border:none; } #spacer { background:rgb(0,70,101);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background-color:rgb(51,69,83); } #toolbar { border:1px;height:100%;padding-top:20px; background: rgb(0,70,101); text-align: left; color: white;min-width:200px;max-width:200px;} QToolBar QToolButton:hover {background-color: rgb(84,142,168);} QToolBar QToolButton:checked {background-color: rgb(26,89,117);}"
#ifdef Q_OS_MAC
...
#else
"QToolBar QToolButton { font-family:Ubuntu;font-size:16px;padding-left:20px;padding-right:200px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(0,70,101);  }"
#endif
...
//    statusBar();
    ...
    progressBarLabel->setSizePolicy(QSizePolicy::Expanding, QSizePolicy::Expanding);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(QIcon(":/icons/send"), tr("&Send BAY"), this);
    sendCoinsAction->setToolTip(tr("Send coins to a BitBay address"));
    sendCoinsAction->setCheckable(true);
    sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
    tabGroup->addAction(sendCoinsAction);

    receiveCoinsAction = new QAction(QIcon(":/icons/receiving_addresses"), tr("&Receive BAY"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About BitBay"), this);
