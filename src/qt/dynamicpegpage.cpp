...
DynamicPegPage::DynamicPegPage(QWidget* parent) : QDialog(parent), ui(new Ui::DynamicPegPage) {
	ui->setupUi(this);
...
void DynamicPegPage::setAmounts() {
	...
	//        ui->comboVotes->setItemText(0, tr("Automatic (recommended), deflation to
	//        %1").arg(last_peak));
	//    else if (last_vote == PEG_VOTE_INFLATE)
	//        ui->comboVotes->setItemText(0, tr("Automatic (recommended), inflation to
	//        %1").arg(last_peak));
	//    else if (last_vote == PEG_VOTE_NOCHANGE)
	//        ui->comboVotes->setItemText(0, tr("Automatic (recommended), no change to
	//        %1").arg(last_peak));
