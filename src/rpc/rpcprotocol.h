...
#define GetIOServiceFromPtr(s) \
	((boost::asio::io_context&)(s->get_executor().context()))  // this one
...
enum RPCErrorCode {
	...
	RPC_WALLET_WRONG_ENC_STATE = -15,  // Command given in wrong wallet encryption state (encrypting
	                                   // an encrypted wallet etc.)
