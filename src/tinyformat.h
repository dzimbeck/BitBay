...
inline const char* streamStateFromFormat(std::ostream&            out,
	...
	out.unsetf(std::ios::adjustfield | std::ios::basefield | std::ios::floatfield |
	           std::ios::showbase | std::ios::boolalpha | std::ios::showpoint | std::ios::showpos |
	           std::ios::uppercase);
...
inline void formatImpl(std::ostream&            out,
	...
	for (int argIndex = 0; argIndex < numFormatters; ++argIndex) {
		...
		int         ntrunc           = -1;
		const char* fmtEnd = streamStateFromFormat(out, spacePadPositive, ntrunc, fmt, formatters,
